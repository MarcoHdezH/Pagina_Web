    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../dashboard.php">Actualizar Informacion</a>
        </div>
          ...
          <fieldset>
            ...
            <form method="POST" action="../acciones.php" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="descripcion" id="" cols="3" required><?php print $resultado['descripcion']?></textarea>
                    </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <input type="submit" class="btn btn-info" name="accion" value="Actualizar"></button>
